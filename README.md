...
## Uso
Depois de baixar a classe [aqui](https://github.com/kristianrose/flower-database/raw/main/DB.php) salve-o em seu diretório raiz e abra-o para ajustar as configurações básicas para sua conexão de banco de dados como host , nome do banco de dados, nome de usuário e senha do banco de dados. E você também pode definir facilmente seu ambiente de desenvolvimento atual para `development` or `production`.
```php
