...
A classe FlowerDB é uma classe construtora de consulta simples em PHP para aumentar sua produtividade, você não pode imaginar quanto tempo vai economizar se estiver usando essa classe! .
## Recursos
* Totalmente seguro:
...
* Fácil uso:
A sintaxe é muito simples e há muitas maneiras de fazer a mesma consulta, então você pode usar da maneira que quiser;)
* Bem documentado :
